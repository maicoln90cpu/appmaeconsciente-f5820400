    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={accessBox}>
          ...
          {expiresAt && (
            <Text style={expiresInfo}>⏰ Seu acesso expira em: {new Date(expiresAt).toLocaleDateString("pt-BR")}</Text>
          )}

          {!expiresAt && <Text style={lifetimeText}>♾️ Você tem acesso vitalício a este produto!</Text>}
        </Section>
        ...
        <Link href="https://dashboard-enxovalcompleto.lovable.app" target="_blank" style={button}>
          Acessar Plataforma
        </Link>
