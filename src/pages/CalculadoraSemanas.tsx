          ...
          <Card className="border-primary/30 bg-primary/5">
            <CardContent className="pt-6 text-center space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                {result.progressPercent.toFixed(0)}% da gestação concluída
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-primary/10">
            <CardContent className="pt-6">
              ...
              <div className="grid grid-cols-3 gap-3 text-center">
                ...
                <div className="p-3 rounded-lg bg-background/80 border">
                  <p className="text-3xl font-bold text-primary">
                    {Math.max(0, 40 - result.weeks)}
                  </p>
                  <p className="text-[11px] text-muted-foreground mt-1">semanas</p>
                </div>
                <div className="p-3 rounded-lg bg-background/80 border">
                  <p className="text-3xl font-bold text-primary">
                    {Math.max(0, Math.ceil((40 - result.weeks) / 4.33))}
                  </p>
              ...
              <p className="text-center text-[11px] text-muted-foreground mt-2">
                {result.progressPercent.toFixed(0)}% concluída • DPP:{' '}
