  ...
  const checkClubAccess = async () => {
    try {
      ...
      const { data: product } = await supabase
        .from("products")
        .select("id, title, slug, description, price, is_active, image_url, features, destination_url, payment_url, trial_enabled, trial_days")
      ...
      const { data: materials } = await supabase
        .from("products")
        .select("id, title, slug, description, price, is_active, image_url, features, destination_url, payment_url")
        .eq("is_active", true)
