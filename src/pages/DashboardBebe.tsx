...
const GrowthChart = lazy(() =>
  import('@/components/crescimento/GrowthChart').then(m => ({ default: m.GrowthChart }))
);
const FoodIntroductionDiary = lazy(() =>
  import('@/components/alimentacao-bebe/FoodIntroductionDiary').then(m => ({
    default: m.FoodIntroductionDiary,
  }))
);
const BottleCalculator = lazy(() =>
  import('@/components/alimentacao-bebe/BottleCalculator').then(m => ({
    default: m.BottleCalculator,
  }))
);
const ColicTracker = lazy(() =>
  import('@/components/bebe/ColicTracker').then(m => ({ default: m.ColicTracker }))
);
const MedicationTimer = lazy(() =>
  import('@/components/bebe/MedicationTimer').then(m => ({ default: m.MedicationTimer }))
);
const AppointmentOrganizer = lazy(() =>
  import('@/components/bebe/AppointmentOrganizer').then(m => ({ default: m.AppointmentOrganizer }))
);
const RoutinePlanner = lazy(() =>
  import('@/components/bebe/RoutinePlanner').then(m => ({ default: m.RoutinePlanner }))
);
const PediatricReportGenerator = lazy(() =>
  import('@/components/bebe/PediatricReportGenerator').then(m => ({
    default: m.PediatricReportGenerator,
  }))
);
const UnifiedCalendar = lazy(() =>
  import('@/components/bebe/UnifiedCalendar').then(m => ({ default: m.UnifiedCalendar }))
);
const DataExporter = lazy(() =>
  import('@/components/bebe/DataExporter').then(m => ({ default: m.DataExporter }))
);
const BabySummaryWidget = lazy(() =>
  import('@/components/bebe/BabySummaryWidget').then(m => ({ default: m.BabySummaryWidget }))
);
const PartnerAccessManager = lazy(() =>
  import('@/components/bebe/PartnerAccessManager').then(m => ({ default: m.PartnerAccessManager }))
);
const NotificationSettings = lazy(() =>
  import('@/components/bebe/NotificationSettings').then(m => ({ default: m.NotificationSettings }))
);
const BabyAchievements = lazy(() =>
  import('@/components/bebe/BabyAchievements').then(m => ({ default: m.BabyAchievements }))
);
const FirstTimesAlbum = lazy(() =>
  import('@/components/bebe/FirstTimesAlbum').then(m => ({ default: m.FirstTimesAlbum }))
);
const VisualTimeline = lazy(() =>
  import('@/components/bebe/VisualTimeline').then(m => ({ default: m.VisualTimeline }))
);
const JaundiceMonitor = lazy(() =>
  import('@/components/bebe/JaundiceMonitor').then(m => ({ default: m.JaundiceMonitor }))
);
const MomWellnessDiary = lazy(() =>
  import('@/components/bebe/MomWellnessDiary').then(m => ({ default: m.MomWellnessDiary }))
);
const TeethTracker = lazy(() =>
  import('@/components/bebe/TeethTracker').then(m => ({ default: m.TeethTracker }))
);
const StimulationBank = lazy(() =>
  import('@/components/bebe/StimulationBank').then(m => ({ default: m.StimulationBank }))
);
const AllergyDiary = lazy(() =>
  import('@/components/bebe/AllergyDiary').then(m => ({ default: m.AllergyDiary }))
);
    ...
    <div className="container py-4 sm:py-6 md:py-8 max-w-6xl space-y-4 sm:space-y-6">
      ...
      <PhaseSelectionModal
        ...
        onOpenChange={open => {
          ...
          if (!open) localStorage.setItem('phase_selection_dismissed', 'true');
        }}
      />
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <DashboardBebeKPIs lastFeeding={lastFeeding} lastSleep={lastSleep} />
          ...
          <DashboardBebeTimeline feedingLogs={feedingLogs24h} sleepLogs={sleepLogs24h} />
        </TabsContent>
