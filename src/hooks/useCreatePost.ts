...
export function useCreatePost({ onPostCreated }: UseCreatePostOptions) {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      await onPostCreated(content, imageUrls, isAdmin && displayName ? displayName : null, categoria || undefined, undefined);
  ...
  }, [content, images, displayName, categoria, isAdmin, onPostCreated, autoSave.deleteDraft, resetForm, toast]);
