...
export function ExamChecklist() {
  ...
  const trimesterLabels = [
    '',
    '1º Trimestre (1-13 sem)',
    '2º Trimestre (14-27 sem)',
    '3º Trimestre (28-40 sem)',
  ];
  const categoryColors: Record<string, string> = {
    sus: 'bg-primary/10 text-primary',
    particular: 'bg-accent text-accent-foreground',
  ...
  const handleAddExam = () => {
    ...
    addCustomExam({
      ...
      trimester: parseInt(newExamTrimester),
  ...
  if (isLoading)
    return <p className="text-muted-foreground text-center py-8">Carregando exames...</p>;
    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent>
          ...
          <Accordion
            type="multiple"
            defaultValue={['tri-1', 'tri-2', 'tri-3']}
            className="space-y-2"
          >
