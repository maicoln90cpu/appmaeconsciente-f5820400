      ...
      {urgentInsights.length > 0 && (
        <div className="p-3 sm:p-4 rounded-lg bg-destructive/10 border border-destructive/30">
          <div className="flex items-center gap-2 mb-1 sm:mb-2">
            ...
            <span className="font-medium text-destructive text-sm sm:text-base truncate">{urgentInsights[0].title}</span>
          </div>
          <p className="text-xs sm:text-sm text-destructive/80 line-clamp-2">{urgentInsights[0].description}</p>
        </div>
      )}
          ...
          <CardContent className="p-3 sm:p-4 pt-0">
            {nextActivity ? (
              <>
                ...
                {nextActivity.urgent && (
                  <Badge variant="secondary" className="mt-1.5 sm:mt-2 text-[10px] sm:text-xs bg-amber-500/20 text-amber-700">
                    Em breve
                  </Badge>
                )}
          ...
          <CardContent className="p-3 sm:p-4 pt-0">
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <span className="text-sm sm:text-lg font-bold truncate">
                {stats.sleepTrendLastWeek === "improving" ? "Melhor" : 
                 stats.sleepTrendLastWeek === "declining" ? "Menos" : "Estável"}
              </span>
            </div>
