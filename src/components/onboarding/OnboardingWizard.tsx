...
const WIZARD_STEPS = [
  ...
  },
  {
    ...
    description: "Planeje e acompanhe todas as compras do enxoval do seu bebê com controle de orçamento e listas inteligentes.",
    image: "📋",
  },
  {
    title: "Acompanhe o Desenvolvimento 📈",
    description: "Registre mamadas, sono e marcos de desenvolvimento. Visualize relatórios e compartilhe com o pediatra.",
    image: "📊",
  },
  {
    title: "Conecte-se com outras Mães 👥",
    description: "Participe de nossa comunidade acolhedora, compartilhe experiências e receba apoio de outras mães.",
    image: "💬",
  },
  {
    title: "Vamos Começar! 🚀",
    description: "Complete os primeiros passos para desbloquear conquistas e fazer parte da nossa comunidade!",
    image: "🏆",
  },
];
