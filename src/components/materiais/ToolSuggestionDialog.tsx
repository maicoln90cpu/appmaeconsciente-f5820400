      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          {currentStep === 2 && (
            <div className="space-y-4">
              <div>
                <Label htmlFor="main_functions">Funcionalidades Principais * (20-1000 caracteres)</Label>
                <Textarea
                  id="main_functions"
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, reference_examples: e.target.value }))}
              ...
              <div>
                ...
                <div className="flex gap-2">
                  {[1, 2, 3, 4, 5].map((rating) => (
                    ...
                    >
                      <Star className="h-4 w-4" fill={formData.priority_rating >= rating ? "currentColor" : "none"} />
                    </Button>
                  ))}
                </div>
              </div>
          ...
          {currentStep === 4 && (
            <div className="space-y-4">
              ...
              <div className="border rounded-lg p-4 bg-muted/50 space-y-2">
                ...
                <p className="text-sm"><strong>Ideia:</strong> {formData.main_idea.substring(0, 100)}...</p>
