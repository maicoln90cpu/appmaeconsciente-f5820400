              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={e => setNewMapping({ ...newMapping, hotmart_id: e.target.value })}
                    placeholder="123456"
                  />
                </div>
                <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={e =>
                        setNewMapping({
                          ...
                          access_duration_days: e.target.checked
                            ? null
                            : newMapping.access_duration_days,
                        })
                      }
                      className="rounded"
                    />
                ...
                <Button onClick={handleAddMapping} className="w-full" disabled={isAdding}>
                  Criar Mapeamento
                </Button>
              </div>
            </DialogContent>
