  ...
  return (
    <div className="border rounded-lg overflow-hidden">
      ...
      <div className="flex flex-wrap gap-0.5 p-1.5 border-b bg-muted/30">
        ...
        <Button size="sm" variant="ghost" className="h-8 w-8 p-0" onClick={addLink} title="Inserir link">
          <LinkIcon className="h-4 w-4" />
        </Button>
        <Button size="sm" variant="ghost" className="h-8 w-8 p-0" onClick={addImage} title="Inserir imagem">
          <ImageIcon className="h-4 w-4" />
        </Button>

        <div className="flex-1" />

        <Button size="sm" variant="ghost" className="h-8 w-8 p-0" onClick={() => editor.chain().focus().undo().run()} disabled={!editor.can().undo()}>
          <Undo className="h-4 w-4" />
        </Button>
        <Button size="sm" variant="ghost" className="h-8 w-8 p-0" onClick={() => editor.chain().focus().redo().run()} disabled={!editor.can().redo()}>
