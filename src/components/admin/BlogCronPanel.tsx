    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Define quantos artigos são gerados e em quais dias da semana
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="border rounded-lg p-4 space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Selecione em quais dias a IA deve gerar artigos
            </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                O sitemap é gerado automaticamente e inclui todos os artigos publicados. Ele é
                atualizado a cada acesso. Para submeter ao Google, use a URL do sitemap no Google
                Search Console.
              </p>
              <div className="flex flex-wrap gap-2 mt-2">
