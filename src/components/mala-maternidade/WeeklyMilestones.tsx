...
const DEFAULT_MILESTONES: Milestone[] = [
  {
    ...
    tasks: [
      ...
      { id: "w28-3", text: "Verificar regras do hospital (visitas, acompanhante)", completed: false },
    ],
  },
  {
    id: "week-32",
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "w35-3", text: "Calcinhas confortáveis (de preferência descartáveis)", completed: false },
...
export const WeeklyMilestones = ({ currentWeek, onMilestoneUpdate }: WeeklyMilestonesProps) => {
  ...
  const getMilestoneStatus = (milestone: Milestone): "pendente" | "em_andamento" | "concluido" | "atrasado" => {
    ...
    switch (status) {
      ...
      default:
        return priority === "alta" 
          ? <Badge variant="outline" className="border-warning text-warning">Prioridade Alta</Badge>
  ...
  const currentMilestone = milestones.find(m => m.week === currentWeek) ||
            ...
            >
              <Card 
                className={`border-l-4 ${
                  status === "concluido" ? "border-l-success bg-success/5" :
                  ...
                  <Button variant="ghost" className="w-full p-4 h-auto justify-between">
                    <div className="flex items-center gap-3 text-left">
                      <div className={`
                        ...
                        ${status === "concluido" ? "bg-success/20 text-success" :
                          status === "atrasado" ? "bg-destructive/20 text-destructive" :
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">
                          {milestone.description} • {completedCount}/{milestone.tasks.length} tarefas
                        </div>
                      </div>
                    </div>
