...
const quickActions = [
  { label: "Mamada", icon: Baby, path: "/materiais/rastreador-amamentacao", color: "bg-pink-500 dark:bg-pink-600" },
  { label: "Sono", icon: Moon, path: "/materiais/diario-sono", color: "bg-indigo-500 dark:bg-indigo-600" },
  { label: "Crescimento", icon: Ruler, path: "/materiais/monitor-desenvolvimento", color: "bg-emerald-500 dark:bg-emerald-600" },
  { label: "Fraldas", icon: Droplets, path: "/materiais/calculadora-fraldas", color: "bg-amber-500 dark:bg-amber-600" },
];
