...
export const StimulationBank = ({ babyProfileId }: Props) => {
  const {
    ...
    removeActivity,
    seedDefaults,
  } = useStimulationBank(babyProfileId);
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Ex: Brincar com blocos"
                  />
                </div>
                <div>
      ...
      {filtered.length > 0 ? (
                ...
                <CardContent className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-1">
                    <Badge variant="secondary" className="text-[10px]">
                      {activity.age_range_start}-{activity.age_range_end}m
                    </Badge>
                    <Badge variant="secondary" className="text-[10px]">
                    ...
                    {activity.completed_count > 0 && (
                      <Badge variant="outline" className="text-[10px]">
                        ✅ {activity.completed_count}x feita
                      </Badge>
                    )}
                  </div>
        ...
        <Card className="border-dashed">
          <CardContent className="flex flex-col items-center py-8 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              {activities.length === 0
                ? "Clique em 'Carregar sugestões' para começar"
