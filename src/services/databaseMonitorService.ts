...
export const TRIGGERS_CATALOG = [
  {
    ...
    description: 'Atualiza automaticamente o campo updated_at ao editar perfil',
  },
  {
    table: 'posts',
    name: 'check_post_rate_limit_trigger',
    event: 'BEFORE INSERT',
    fn: 'check_post_rate_limit',
    description: 'Limita 1 post por minuto para evitar spam',
  },
  {
    table: 'baby_feeding_logs',
    name: 'check_feeding_rate_limit_trigger',
    event: 'BEFORE INSERT',
    fn: 'check_feeding_rate_limit',
    description: 'Limita 1 registro a cada 10 segundos',
  },
  {
    table: 'baby_sleep_logs',
    name: 'check_sleep_rate_limit_trigger',
    event: 'BEFORE INSERT',
    fn: 'check_sleep_rate_limit',
    description: 'Limita 1 registro a cada 10 segundos',
  },
  {
    table: 'coupon_usage',
    name: 'increment_coupon_usage_trigger',
    event: 'AFTER INSERT',
    fn: 'increment_coupon_usage',
    description: 'Incrementa contador de uso do cupom',
  },
  {
    table: 'notifications',
    name: 'create_user_notifications_trigger',
    event: 'AFTER INSERT',
    fn: 'create_user_notifications',
    description: 'Distribui notificação global para todos os usuários',
  },
  {
    table: 'auth.users',
    name: 'handle_new_user_profile_trigger',
    event: 'AFTER INSERT',
    fn: 'handle_new_user_profile',
    description: 'Cria perfil + role + trial ao registrar usuário',
  },
  {
    table: 'auth.users',
    name: 'assign_admin_role_trigger',
    event: 'AFTER INSERT',
    fn: 'assign_admin_role_for_specific_email',
    description: 'Atribui role admin para email específico',
  },
];
...
export const CRON_JOBS_CATALOG = [
  {
    name: 'auto-engage-community',
    frequency: 'Configurável (2x-8x/dia)',
    description:
      'Engajamento automático da comunidade com posts e comentários de usuários virtuais',
    status: 'ativo',
  },
  {
    name: 'auto-generate-blog-post',
    frequency: 'Configurável (1x-3x/dia)',
    description: 'Geração automática de posts para o blog usando IA',
    status: 'ativo',
  },
  {
    name: 'cleanup-old-logs',
    frequency: 'Diário',
    description: 'Limpeza de logs de acesso e segurança antigos (>90 dias)',
    status: 'ativo',
  },
  {
    name: 'cleanup-monitoring-logs',
    frequency: 'Diário',
    description: 'Limpeza de logs de monitoramento (erros 90d, performance 30d, audit 365d)',
    status: 'ativo',
  },
  {
    name: 'refresh-leaderboard',
    frequency: 'A cada 6 horas',
    description: 'Recalcula o ranking de gamificação com XP semanal',
    status: 'ativo',
  },
];
...
export const EDGE_FUNCTIONS_CATALOG = [
  {
    ...
    category: 'Comunidade',
    trigger: 'pg_cron',
    description: 'Gera posts e comentários automáticos com usuários virtuais',
  },
  {
    name: 'generate-comment',
    category: 'Comunidade',
    trigger: 'HTTP POST',
    description: 'Gera comentário de IA para um post específico',
  },
  {
    name: 'moderate-post',
    category: 'Comunidade',
    trigger: 'HTTP POST',
    description: 'Modera conteúdo de posts com IA',
  },
  {
    name: 'seed-community',
    category: 'Comunidade',
    trigger: 'HTTP POST',
    description: 'Popula a comunidade com posts iniciais',
  },
  {
    name: 'generate-blog-post',
    category: 'Blog',
    trigger: 'pg_cron / HTTP',
    description: 'Gera post completo do blog com IA (texto + imagem + SEO)',
  },
  {
    name: 'track-blog-view',
    category: 'Blog',
    trigger: 'HTTP POST',
    description: 'Rastreia visualizações do blog filtrando bots',
  },
  {
    name: 'sitemap-xml',
    category: 'Blog/SEO',
    trigger: 'HTTP GET',
    description: 'Gera sitemap XML dinâmico para o blog',
  },
  {
    name: 'nutrition-chat',
    category: 'Chatbot',
    trigger: 'HTTP POST',
    description: 'Chat de nutrição infantil com IA',
  },
  {
    name: 'generate-nutrition-plan',
    category: 'Nutrição',
    trigger: 'HTTP POST',
    description: 'Gera plano nutricional personalizado',
  },
  {
    name: 'generate-meal-plan',
    category: 'Nutrição',
    trigger: 'HTTP POST',
    description: 'Gera cardápio semanal personalizado',
  },
  {
    name: 'generate-recipes',
    category: 'Nutrição',
    trigger: 'HTTP POST',
    description: 'Gera receitas baseadas em ingredientes',
  },
  {
    name: 'generate-exercises',
    category: 'Saúde',
    trigger: 'HTTP POST',
    description: 'Gera plano de exercícios pós-parto',
  },
  {
    name: 'check-development-alerts',
    category: 'Bebê',
    trigger: 'HTTP POST',
    description: 'Verifica alertas de desenvolvimento do bebê',
  },
  {
    name: 'generate-avatar',
    category: 'Perfil',
    trigger: 'HTTP POST',
    description: 'Gera avatar com IA para perfil',
  },
  {
    name: 'hotmart-webhook',
    category: 'Pagamentos',
    trigger: 'Webhook',
    description: 'Processa webhooks da Hotmart (compras, cancelamentos)',
  },
  {
    name: 'grant-trial-access',
    category: 'Pagamentos',
    trigger: 'HTTP POST',
    description: 'Concede acesso trial a produtos',
  },
  {
    name: 'resend-purchase-credentials',
    category: 'Pagamentos',
    trigger: 'HTTP POST',
    description: 'Reenvia credenciais de compra por email',
  },
  {
    name: 'apply-promotion',
    category: 'Comercial',
    trigger: 'HTTP POST',
    description: 'Aplica promoções e descontos',
  },
  {
    name: 'send-resend-email',
    category: 'Notificações',
    trigger: 'HTTP POST',
    description: 'Envia emails transacionais via Resend',
  },
  {
    name: 'send-weekly-recovery-email',
    category: 'Notificações',
    trigger: 'HTTP POST',
    description: 'Envia email semanal de recuperação',
  },
  {
    name: 'notify-ticket-created',
    category: 'Suporte',
    trigger: 'HTTP POST',
    description: 'Notifica sobre novo ticket de suporte',
  },
  {
    name: 'check-exchange-alerts',
    category: 'Enxoval',
    trigger: 'HTTP POST',
    description: 'Verifica alertas de troca de tamanho',
  },
  {
    name: 'create-user-admin',
    category: 'Admin',
    trigger: 'HTTP POST',
    description: 'Cria usuário via painel admin',
  },
  {
    name: 'delete-user-admin',
    category: 'Admin',
    trigger: 'HTTP POST',
    description: 'Exclui usuário via painel admin',
  },
  {
    name: 'delete-user-data',
    category: 'LGPD',
    trigger: 'HTTP POST',
    description: 'Exclui todos os dados do usuário (LGPD)',
  },
  {
    name: 'export-user-data',
    category: 'LGPD',
    trigger: 'HTTP POST',
    description: 'Exporta dados do usuário (LGPD)',
  },
  {
    name: 'export-users-crm',
    category: 'Admin',
    trigger: 'HTTP POST',
    description: 'Exporta lista de usuários para CRM',
  },
  {
    name: 'cleanup-old-logs',
    category: 'Manutenção',
  ...
  {
    name: 'configure-auth-security',
    category: 'Segurança',
    trigger: 'HTTP POST',
    description: 'Configura políticas de segurança de autenticação',
  },
  {
    name: 'system-health-check',
    category: 'Monitoramento',
    trigger: 'HTTP POST',
    description: 'Retorna estatísticas do banco de dados para o painel admin',
  },
];
