                  ...
                  <Routes>
                    ...
                    <Route element={<ProtectedRoute />}>
                      ...
                      <Route
                        path="/dashboard-bebe"
                        element={
                          <FeaturePage name="Dashboard Bebê">
                            <DashboardBebe />
                          </FeaturePage>
                        }
                      />
                      ...
                      <Route element={<ProductRoute productSlug="calculadora-fraldas" />}>
                        <Route
                          ...
                          element={
                            <FeaturePage name="Calculadora de Fraldas">
                              <CalculadoraFraldas />
                            </FeaturePage>
                          }
                        />
                      ...
                      <Route element={<ProductRoute productSlug="mala-maternidade" />}>
                        <Route
                          ...
                          element={
                            <FeaturePage name="Mala da Maternidade">
                              <MalaDaMaternidade />
                            </FeaturePage>
                          }
                        />
                      ...
                      <Route element={<ProductRoute productSlug="diario-sono" />}>
                        <Route
                          ...
                          element={
                            <FeaturePage name="Diário de Sono">
                              <DiarioSono />
                            </FeaturePage>
                          }
                        />
                      ...
                      <Route element={<ProductRoute productSlug="rastreador-amamentacao" />}>
                        <Route
                          ...
                          element={
                            <FeaturePage name="Amamentação">
                              <RastreadorAmamentacao />
                            </FeaturePage>
                          }
                        />
                      </Route>
                      ...
                      <Route element={<ProductRoute productSlug="recuperacao-pos-parto" />}>
                        <Route
                          ...
                          element={
                            <FeaturePage name="Recuperação Pós-Parto">
                              <RecuperacaoPosPartoPage />
                            </FeaturePage>
                          }
                        />
                      </Route>
                      ...
                      <Route element={<ProductRoute productSlug="monitor-desenvolvimento" />}>
                        <Route
                          ...
                          element={
                            <FeaturePage name="Desenvolvimento">
                              <MonitorDesenvolvimento />
                            </FeaturePage>
                          }
                        />
                      </Route>
                      ...
                      <Route element={<ProductRoute productSlug="ferramentas-gestacao" />}>
                        <Route
                          path="/materiais/ferramentas-gestacao"
                          element={
                            <FeaturePage name="Gestação">
                              <FerramentasGestacao />
                            </FeaturePage>
                          }
                        />
                      ...
                      <Route element={<ProductRoute productSlug="calculadora-semanas" />}>
                        <Route
                          path="/calculadora-semanas"
                          element={
                            <FeaturePage name="Calculadora de Semanas">
                              <CalculadoraSemanas />
                            </FeaturePage>
                          }
                        />
                      ...
                      <Route element={<ProductRoute productSlug="checklist-documentos" />}>
                        <Route
                          ...
                          element={
                            <FeaturePage name="Checklist Documentos">
                              <ChecklistDocumentos />
                            </FeaturePage>
                          }
                        />
                      ...
                      <Route element={<ProductRoute productSlug="checklist-quartinho" />}>
                        <Route
                          path="/checklist-quartinho"
                          element={
                            <FeaturePage name="Checklist Quartinho">
                              <ChecklistQuartinho />
                            </FeaturePage>
                          }
                        />
                      ...
                      <Route element={<ProductRoute productSlug="timer-mamada" />}>
                        <Route
                          path="/timer-mamada"
                          element={
                            <FeaturePage name="Timer de Mamada">
                              <TimerMamada />
                            </FeaturePage>
                          }
                        />
                      ...
                      <Route element={<ProductRoute productSlug="diario-crescimento" />}>
                        <Route
                          path="/diario-crescimento"
                          element={
                            <FeaturePage name="Diário de Crescimento">
                              <DiarioCrescimento />
                            </FeaturePage>
                          }
                        />
                      ...
                      <Route element={<ProductRoute productSlug="planejador-rotina" />}>
                        <Route
                          path="/planejador-rotina"
                          element={
                            <FeaturePage name="Planejador de Rotina">
                              <PlanejadorRotina />
                            </FeaturePage>
                          }
                        />
                      ...
                      <Route element={<ProductRoute productSlug="introducao-alimentar" />}>
                        <Route
                          path="/introducao-alimentar"
                          element={
                            <FeaturePage name="Introdução Alimentar">
                              <IntroducaoAlimentar />
                            </FeaturePage>
                          }
                        />
                      ...
                      <Route element={<ProductRoute productSlug="album-marcos" />}>
                        <Route
                          path="/album-marcos"
                          element={
                            <FeaturePage name="Álbum de Marcos">
                              <AlbumMarcos />
                            </FeaturePage>
                          }
                        />
